...
class FormDetailsController extends Controller
{
    public function create(Request $request)
    {
        $formDetails = FormDetails::create([
            ...
            "rbs_door_sensor" => $request->rbs_door_sensor,
            "rbs_dummy" => $request->rbs_dummy,
            ...
            "commercial_power_cpreadings" => $request->commercial_power_cpreadings,
        ...
        $formBooleans = FormBoolean::create([
            ...
            "gen1_sensor_status" => $request->gen1_sensor_status,
            "gen2_sensor_status" => $request->gen2_sensor_status,
            ...
            "water_leakage_radiator" => $request->water_leakage_radiator,
            "water_leakage_fils" => $request->water_leakage_fils,
            ...
            "alarm_generator_ok" => $request->alarm_generator_ok,
            "alarm_generator_not_ok" => $request->alarm_generator_not_ok,
            ...
            "form_details_id" => $formDetails->id
    ...
    public function getForms()
    {
        ...
        $formBooleans = FormBoolean::all();
        $forms = FormDetails::all();
        $arr = [];
        for ($i = 0; $i < count($forms); $i++) {
            $obj = [
                'formDetails' => $forms[$i],
                'formBooleans' => $formBooleans[$i]
            ];
            array_push(
                $arr,
                $obj
